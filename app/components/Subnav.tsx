...
function IndustriesMegaMenu({ mobile = false }) {
  return (
    <>
      <Item mobile={mobile} title="E-Commerce" desc="AI for retail, conversions & product insights." href="/industries/ecommerce" Icon={ShoppingBag} />
      <Item mobile={mobile} title="Real Estate" desc="Smart lead handling & property automation." href="/industries/real-estate" Icon={Building2} />
      <Item mobile={mobile} title="Healthcare" desc="HIPAA-friendly automations & patient tools." href="/industries/healthcare" Icon={HeartPulse} />
      <Item mobile={mobile} title="Agencies" desc="Scale client delivery & operations instantly." href="/industries/agencies" Icon={Users} />
    </>
  );
}
...
function ResourcesMegaMenu({ mobile = false }) {
  return (
    <>
      <Item mobile={mobile} title="Blog" desc="AI insights & articles for businesses." href="/blog" Icon={BookOpen} />
      <Item mobile={mobile} title="Case Studies" desc="Real results from clients using our AI solutions." href="/case-studies" Icon={BadgeCheck} />
      <Item mobile={mobile} title="Guides" desc="Implementation guides & best practices." href="/guides" Icon={FileText} />
      <Item mobile={mobile} title="Documentation" desc="Technical docs & integrations." href="/docs" Icon={PanelsTopLeft} />
    </>
  );
}
