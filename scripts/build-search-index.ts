...
const pages = [
  {
    slug: "/",
    file: path.join(process.cwd(), "app", "page.tsx"),
    title: "Home"
  },
  {
    slug: "/about",
    file: path.join(process.cwd(), "app", "about", "page.tsx"),
    title: "About"
  },
  {
    slug: "/contact",
    file: path.join(process.cwd(), "app", "contact", "page.tsx"),
    title: "Contact"
  },
  {
    slug: "/docs",
  ...
  },
  {
    ...
    file: path.join(process.cwd(), "app", "docs", "getting-started", "page.tsx"),
 ...
 */
const extractText = (fileContent: string): string => {
  // Remove JSX tags
